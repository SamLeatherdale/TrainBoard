...
export class FocusableItem {
    ...
    private ignore = defaultIgnore;

    constructor(ele: HTMLElement) {
        this.element = ele;
        if (ele.classList.contains("dpad-ignore-x")) {
            this.ignore.left = true;
            this.ignore.right = true;
        }
        if (ele.classList.contains("dpad-ignore-y")) {
            this.ignore.up = true;
            this.ignore.down = true;
        }
